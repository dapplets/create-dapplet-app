...
export const scriptAdapterNotServerNotOverlay = {
  ...
  "start": "concurrently -c \"magenta,cyan\" -n \"dapplet,adapter\" \"npm run start:dapplet\" \"npm run start:adapter\"",
  "start:dapplet": "cd dapplet && npm start",
...
export const cacheDirectoriesAdapterYesServerYesOverlay = ["dapplet/node_modules",
